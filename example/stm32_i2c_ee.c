/**
  ...
  * @version V4.5.0
  * @date    07-March-2011
  * @brief   stm32官方例程，硬件I2C访问M24CXX EEPROM。 
  *          
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed STM32 hardware resources (I2C and 
  *          GPIO) are defined in stm32_i2c.h file, and the initialization is 
  *          performed in sEE_LowLevel_Init() function declared in stm32_i2c.c 
  *          file.
